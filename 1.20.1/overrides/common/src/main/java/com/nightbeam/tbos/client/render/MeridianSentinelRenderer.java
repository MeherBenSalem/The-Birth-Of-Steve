...
public final class MeridianSentinelRenderer extends MobRenderer<MeridianSentinelEntity, MeridianSentinelModel> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Yesterglass.MOD_ID, "textures/entity/meridian_sentinel.png");
    private static final ResourceLocation CORE =
            new ResourceLocation(Yesterglass.MOD_ID, "textures/entity/meridian_sentinel_core.png");
