 ...
 * TestFunction registry. Minecraft 1.20.1 predates that registry, so target
...
public final class ModGameTests {
    ...
    /**
     * The 1.20.1 test API has no {@code Registries.TEST_FUNCTION}: it discovers
    ...
    public static void fracturedArchiveDimensionLoads(GameTestHelper helper) {
        ...
        helper.assertTrue(
                resources.getResource(new ResourceLocation(
    ...
    public static void archiveRunCodecRoundTrip(GameTestHelper helper) {
        ...
        ArchiveReturnPoint firstReturn = new ArchiveReturnPoint(
                new ResourceLocation("overworld"), new BlockPos(12, 70, -8), 45.0F, 10.0F);
        ArchiveReturnPoint secondReturn = new ArchiveReturnPoint(
                new ResourceLocation("overworld"), new BlockPos(14, 70, -8), 90.0F, 0.0F);
        ...
        List<ArchiveRoomPlan> rooms = java.util.stream.IntStream.range(0, 9)
                .mapToObj(index -> new ArchiveRoomPlan(
                        new ResourceLocation(Yesterglass.MOD_ID, "test_room_" + index),
                        Math.min(2, index / 3),
                        index,
                        1000L + index))
                .toList();
        ...
        com.google.gson.JsonElement encoded = ArchiveRun.CODEC.encodeStart(JsonOps.INSTANCE, expected).result().orElseThrow();
        ArchiveRun decoded = ArchiveRun.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow();
    ...
    private static ArchiveRun testArchiveRun(UUID runId, int instanceSlot, UUID memberId) {
        ArchiveReturnPoint returnPoint = new ArchiveReturnPoint(
                new ResourceLocation("overworld"), new BlockPos(0, 72, 0), 0.0F, 0.0F);
        List<ArchiveRoomPlan> rooms = java.util.stream.IntStream.range(0, 9)
                .mapToObj(index -> new ArchiveRoomPlan(
                        new ResourceLocation(Yesterglass.MOD_ID, "storage_room_" + index),
                        Math.min(2, index / 3),
                        index,
                        7000L + index))
                .toList();
    ...
    public static void archiveRunGeneratorIsDeterministicAndVaried(GameTestHelper helper) {
        ...
        var encoded = ArchiveDungeonGraph.CODEC.encodeStart(JsonOps.INSTANCE, seedEleven).result().orElseThrow();
        helper.assertTrue(
                ArchiveDungeonGraph.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow().equals(seedEleven),
    ...
    public static void archiveRoomBlueprintIsBoundedAndWalkable(GameTestHelper helper) {
        ...
        ArchiveReturnPoint returnPoint = new ArchiveReturnPoint(
                new ResourceLocation("overworld"), new BlockPos(4, 80, 4), 0.0F, 0.0F);
    ...
    public static void archiveDungeonContractIsComplete(GameTestHelper helper) {
        ...
        ArchiveRun run = ArchiveRun.create(
                ...
                List.of(new ArchiveRunMember(
                        ...
                        new ArchiveReturnPoint(
                                new ResourceLocation("overworld"), new BlockPos(0, 80, 0), 0.0F, 0.0F))),
                maximum);
        ...
        helper.assertTrue(
                !ArchiveRoomPlacer.doorwayClear(
                        run,
                        vertical.getKey(),
                        List.of(new AABB(firstSeal.get(0)).inflate(0.1D))),
        ...
        ArchiveRun partyClaims = ArchiveRun.create(
                ...
                1,
                List.of(
                        new ArchiveRunMember(memberId, run.members().get(0).returnPoint()),
                        new ArchiveRunMember(cachePartnerId, run.members().get(0).returnPoint())),
                maximum);
        ...
        var encoded = ArchiveRun.CODEC.encodeStart(JsonOps.INSTANCE, claimed).result().orElseThrow();
        helper.assertTrue(
                ArchiveRun.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow()
    ...
    public static void archiveFloorProgressionIsEndless(GameTestHelper helper) {
        ...
        com.google.gson.JsonElement encodedRun = ArchiveRun.CODEC
                ...
                .result().orElseThrow();
        ArchiveRun decodedRun = ArchiveRun.CODEC.parse(JsonOps.INSTANCE, encodedRun).result().orElseThrow();
        helper.assertTrue(
        ...
        helper.assertTrue(
                floorOne.runId().equals(active.runId())
                        ...
                        && floorOne.members().get(0).returnPoint().equals(active.members().get(0).returnPoint()),
        ...
        helper.assertTrue(
                floorOne.floorState().retiredFloors().size() == 1
                        && floorOne.floorState().retiredFloors().get(0).instanceSlot() == active.instanceSlot(),
        ...
        com.google.gson.JsonElement encoded = ArchiveRun.CODEC.encodeStart(JsonOps.INSTANCE, floorTwo).result().orElseThrow();
        ArchiveRun decoded = ArchiveRun.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow();
    ...
    public static void archiveEncounterStatePersistsProgress(GameTestHelper helper) {
        ...
        com.google.gson.JsonElement encoded = ArchiveEncounterState.CODEC
                ...
                .result().orElseThrow();
        helper.assertTrue(
                ArchiveEncounterState.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow().equals(phaseTwo),
    ...
    public static void siteCodecPreservesAuthoredState(GameTestHelper helper) {
        TemporalSite original = TemporalSite.create(
                ...
                .withProgressFlag(1)
                .stable(TemporalState.REMEMBERED);
        com.google.gson.JsonElement encoded = TemporalSite.CODEC.encodeStart(JsonOps.INSTANCE, original).result().orElseThrow();
        TemporalSite decoded = TemporalSite.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow();
    ...
    public static void invalidDefinitionMarkerIsRejected(GameTestHelper helper) {
        ...
        try {
            new TemporalSiteDefinition(
                    new ResourceLocation(Yesterglass.MOD_ID, "invalid_test"),
                    16,
                    16,
                    -1,
                    8,
    ...
    public static void hallMarkersRotateTogether(GameTestHelper helper) {
        ...
        BlockPos localDial = hall.alignmentMechanisms().get(0).position();
        BlockPos localTarget = hall.alignmentMechanisms().get(0).target();
    ...
    public static void choirMarkersRotateTogether(GameTestHelper helper) {
        ...
        BlockPos bell = choir.worldPosition(
                origin,
                choir.choirBells().get(0).position(),
                Rotation.COUNTERCLOCKWISE_90);
        BlockPos imprint = choir.worldPosition(
                origin,
                choir.choirBells().get(0).imprintPositions().get(0),
                Rotation.COUNTERCLOCKWISE_90);
    ...
    public static void meridianCompletionBuildsDecayedRoute(GameTestHelper helper) {
        ...
        helper.assertTrue(
                helper.getLevel().getBlockState(relays.get(0)).is(ModBlocks.MERIDIAN_RELAY.get()),
        ...
        helper.assertTrue(
                helper.getLevel()
                        .getBlockState(TemporalSiteManager.meridianPowerChannelPositions(remembered).get(0))
    ...
    public static void meridianResetAndDestinationSafety(GameTestHelper helper) {
        ...
        helper.assertTrue(
                TemporalSiteManager.routeBrokenMeridian(player, seals.get(0)),
    ...
    public static void meridianMarkersRotateTogether(GameTestHelper helper) {
        ...
        BlockPos relay = meridian.worldPosition(
                origin,
                meridian.meridianRelays().get(0).positions().get(0),
                Rotation.CLOCKWISE_90);
        BlockPos channel = meridian.worldPosition(
                origin,
                meridian.meridianRelays().get(0).powerChannels().get(0).get(0),
                Rotation.CLOCKWISE_90);
    ...
    public static void orreryGeometryFollowsTemporalState(GameTestHelper helper) {
        ...
        helper.assertTrue(
                helper.getLevel().getBlockState(TemporalSiteManager.orreryCorePositions(site).get(0))
        ...
        OrreryDefinition orrery = definition.orreries().get(0);
        ...
        BlockPos rotatedAnchor = definition.worldPosition(
                origin, orrery.memoryAnchors().get(0), Rotation.CLOCKWISE_90);
        helper.assertTrue(
    ...
    public static void orreryCoreAndAnchorsControlEncounter(GameTestHelper helper) {
        ...
        BlockPos anchor = TemporalSiteManager.orreryAnchorPositions(site).get(0);
    ...
    public static void archiveBlueprintHoldsAcrossSeeds(GameTestHelper helper) {
        ...
        for (long seed = 0L; seed < 32L; seed++) {
            ...
            if (components.size() > 1) {
                ...
                java.util.List<BlockPos> smallest = components.get(0);
                helper.fail("seed " + seed + ": floor is not one connected solid - "
                        + components.size() + " separate pieces, smallest is "
                        + smallest.size() + " block(s) adrift at " + smallest.get(0) + " state=" + blueprint.placements().stream().filter(p -> p.position().equals(smallest.get(0))).map(p -> p.state().toString()).toList());
            }
    ...
    public static void curatorRuntimePersistsHealthAndReward(GameTestHelper helper) {
        ...
        helper.assertTrue(
                helper.getLevel().getBlockState(TemporalSiteManager.orreryCorePositions(defeated).get(0))
    ...
    public static void memoryLanternPersistsPlaybackState(GameTestHelper helper) {
        ...
        net.minecraft.nbt.CompoundTag saved = lantern.saveWithoutMetadata();
    ...
    public static void fractureShrinePlanIsStableAndBuildsOnce(GameTestHelper helper) {
        ...
        try {
            ...
            com.google.gson.JsonElement encoded =
                    FractureShrinePlan.CODEC.encodeStart(JsonOps.INSTANCE, plans.get(0)).result().orElseThrow();
            helper.assertTrue(
                    FractureShrinePlan.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow().equals(plans.get(0)),
    ...
    public static void adventureWorldMetadataPersistsCoordinates(GameTestHelper helper) {
        ...
        FractureShrinePlacement placement = new FractureShrinePlacement(
                ...
                shrineOrigin);
        com.google.gson.JsonElement encoded =
                FractureShrinePlacement.CODEC.encodeStart(JsonOps.INSTANCE, placement).result().orElseThrow();
        FractureShrinePlacement decoded = FractureShrinePlacement.CODEC.parse(JsonOps.INSTANCE, encoded).result().orElseThrow();
