...
public record ArchiveRoomPlan(
    ...
    public static final Codec<ArchiveRoomPlan> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ResourceLocation.CODEC.fieldOf("room_id").forGetter(ArchiveRoomPlan::roomId),
    ...
    public ArchiveRoomPlan(ResourceLocation roomId, int level, int slot, long encounterSeed) {
