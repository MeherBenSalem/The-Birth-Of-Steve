...
public final class MemoryLeechEntity extends Monster {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(POUNCE_PHASE, (byte) PouncePhase.IDLE.ordinal());
        this.entityData.define(POUNCE_PHASE_TICKS, 0);
    }
    ...
    private static final class SiphoningPounceGoal extends Goal {
        ...
        @Override
        public void tick() {
            if (!(leech.level() instanceof ServerLevel level)) {
                return;
            }
