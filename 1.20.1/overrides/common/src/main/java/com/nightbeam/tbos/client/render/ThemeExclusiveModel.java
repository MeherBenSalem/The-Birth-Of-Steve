...
/** A 1.20.1 entity-model adapter for the same authored silhouettes and posers. */
public final class ThemeExclusiveModel extends EntityModel<ThemeExclusiveEntity> {
    ...
    public void renderToBuffer(
            ...
            float blue,
            float alpha) {
        rig.root().render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }
}
