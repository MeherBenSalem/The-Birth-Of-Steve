...
public final class ParallaxWraithEntity extends Monster {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DISPLACE_PHASE, (byte) DisplacePhase.IDLE.ordinal());
        this.entityData.define(DISPLACE_PHASE_TICKS, 0);
    }
    ...
    private static final class ParallaxDisplacementGoal extends Goal {
        ...
        @Override
        public void tick() {
            if (!(wraith.level() instanceof ServerLevel level)) {
                return;
            }
