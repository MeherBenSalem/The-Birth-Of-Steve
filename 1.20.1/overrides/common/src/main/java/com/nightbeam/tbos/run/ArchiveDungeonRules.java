...
public record ArchiveDungeonRules(
        Set<ResourceLocation> allowedTemplates,
        Map<ResourceLocation, Integer> templateWeights,
        Map<ResourceLocation, Integer> lootTableWeights,
        Map<ResourceLocation, List<EnemyWeight>> enemyPools,
        ResourceLocation bossTemplate,
    ...
    public static final ResourceLocation FORGOTTEN_LEGION = id("encounters/forgotten_legion");
    public static final ResourceLocation ELITE_ECHOES = id("encounters/elite_echoes");
    public static final ResourceLocation RUINED_GUARDIAN = id("encounters/ruined_guardian");
    public static final ResourceLocation HOUR_CANTOR_POOL = id("encounters/hour_cantor");
    public static final ResourceLocation DEFAULT_BOSS = id("hour_cantor");
    ...
    public static final ArchiveDungeonRules DEFAULT = new ArchiveDungeonRules(
            ...
            Map.of(
                    FORGOTTEN_LEGION, List.of(
                            ...
                            new EnemyWeight(ArchiveEnemyKind.LENSWARD, 1)),
                    ELITE_ECHOES, List.of(
                            ...
                            new EnemyWeight(ArchiveEnemyKind.LENSWARD, 3),
                            new EnemyWeight(ArchiveEnemyKind.MINOTAUR, 2)),
                    RUINED_GUARDIAN, List.of(
                            ...
                            new EnemyWeight(ArchiveEnemyKind.MINOTAUR, 3)),
    ...
    public boolean allows(ResourceLocation templateId) {
    ...
    public int lootTableWeight(ResourceLocation table) {
        return lootTableWeights.getOrDefault(table, 1);
    }

    public List<EnemyWeight> enemyPool(ResourceLocation group) {
        return enemyPools.getOrDefault(group, DEFAULT.enemyPools.getOrDefault(group,
                DEFAULT.enemyPools.get(FORGOTTEN_LEGION)));
    }

    public ArchiveEnemyKind chooseEnemy(ResourceLocation group, RandomSource random) {
        ...
        return pool.get(pool.size()-1).kind();
    }

    public ArchiveEnemyKind chooseEnemy(
            ResourceLocation group, RandomSource random, ArchiveFloorTheme theme, long echoCycle) {
    ...
    public List<EnemyWeight> mergedPool(ResourceLocation group, ArchiveFloorTheme theme, long echoCycle) {
