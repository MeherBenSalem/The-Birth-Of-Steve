...
public final class GreekGui {
    ...
    private static final ResourceLocation PANELS = new ResourceLocation("tbos", "textures/gui/greek/panels.png");
    private static final ResourceLocation ORNAMENTS = new ResourceLocation("tbos", "textures/gui/greek/ornaments.png");
