...
public final class ParallaxWraithRenderer extends MobRenderer<ParallaxWraithEntity, ParallaxWraithModel> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Yesterglass.MOD_ID, "textures/entity/parallax_wraith.png");
    private static final ResourceLocation CORE =
            new ResourceLocation(Yesterglass.MOD_ID, "textures/entity/parallax_wraith_core.png");
