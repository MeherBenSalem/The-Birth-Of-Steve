...
public final class ArchiveRunGenerator {
    ...
    public static final ResourceLocation PARALLAX_WAKE = id("parallax_wake");
    public static final ResourceLocation STARLESS_GALLERY = id("starless_gallery");
    public static final ResourceLocation LENSWRIGHT_CROSSING = id("lenswright_crossing");
    public static final ResourceLocation ECHO_FOUNDRY = id("echo_foundry");
    public static final ResourceLocation MERIDIAN_SENTINEL = id("meridian_sentinel");
    public static final ResourceLocation GLASSBOUND_HUNTSMAN = id("glassbound_huntsman");
    public static final ResourceLocation HALL_ALIGNMENT_REFORGED = id("hall_alignment_reforged");
    public static final ResourceLocation SPLIT_WORKSHOP = id("lenswright_crossing");
    public static final ResourceLocation CHRONICLE_STACK = id("chronicle_stack");
    public static final ResourceLocation BRONZE_REVISER = id("bronze_reviser");
    public static final ResourceLocation PHASE_FOUNDRY = id("echo_foundry");
    public static final ResourceLocation CLOCKLESS_VAULT = id("sealed_reliquary");
    public static final ResourceLocation ARCHIVIST_TRIBUNAL = id("archivist_tribunal");
    public static final ResourceLocation MERIDIAN_ENGINE = id("meridian_sentinel");
    public static final ResourceLocation CHOIR_OF_HOURS_REFORGED = id("choir_of_hours_reforged");
    public static final ResourceLocation INVERTED_SCRIPTORIUM = id("annalist_vigil");
    public static final ResourceLocation MEMORY_MAZE = id("buried_index");
    public static final ResourceLocation RESONANCE_CATWALK = id("meridian_drop");
    public static final ResourceLocation HOUR_CANTOR = id("hour_cantor");
    ...
    public static ArchiveEncounterKind kindFor(ResourceLocation roomId, int slot) {
    ...
    private static Frontier weightedFrontier(
        ...
        return frontiers.get(frontiers.size()-1);
    }
    ...
    private static int chooseBossParent(
        ...
        int farthestDepth = candidates.get(0).depth;
    ...
    private static void validateConfiguredTemplates(ArchiveDungeonSettings settings) {
        if (!settings.rules().allowedTemplates().isEmpty()) {
            Set<ResourceLocation> known = ArchiveRoomTemplates.all().stream()
                    .map(ArchiveRoomTemplate::id)
                    .collect(java.util.stream.Collectors.toSet());
            Set<ResourceLocation> unknown = settings.rules().allowedTemplates().stream()
    ...
    private static ResourceLocation id(String path) {
        return new ResourceLocation(Yesterglass.MOD_ID, path);
    }
