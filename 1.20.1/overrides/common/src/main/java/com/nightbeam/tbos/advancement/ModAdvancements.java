...
public final class ModAdvancements {
    ...
    private static boolean awardIfNew(ServerPlayer player, AdvancementStep step) {
        ResourceLocation id = new ResourceLocation(Yesterglass.MOD_ID, step.path());
        Advancement advancement = player.level().getServer().getAdvancements().getAdvancement(id);
        if (advancement == null) {
            return false;
        }
    ...
    private static boolean completed(ServerPlayer player, String path) {
        ResourceLocation id = new ResourceLocation(Yesterglass.MOD_ID, path);
        Advancement advancement = player.level().getServer().getAdvancements().getAdvancement(id);
