...
public record TemporalSite(
    ...
    public static final Codec<TemporalSite> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ResourceLocation.CODEC.optionalFieldOf("definition_id", BuiltInTemporalSites.PARALLAX_ATRIUM_ID)
    ...
    public static TemporalSite create(UUID siteId, ResourceLocation definitionId, BlockPos origin, Rotation rotation) {
