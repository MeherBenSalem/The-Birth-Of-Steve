...
public record ArchiveReturnPoint(ResourceLocation dimension, BlockPos position, float yRot, float xRot) {
    public static final Codec<ArchiveReturnPoint> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ResourceLocation.CODEC.fieldOf("dimension").forGetter(ArchiveReturnPoint::dimension),
