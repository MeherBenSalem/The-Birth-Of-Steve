 ...
 */
public final class HourCantorModel extends EntityModel<HourCantorRenderState> {
    public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(
            Identifier.fromNamespaceAndPath(Yesterglass.MOD_ID, "hour_cantor"),
            "main");
    ...
    @Override
    public void setupAnim(HourCantorRenderState state) {
