 ...
 */
public final class ParallaxWraithModel extends EntityModel<ParallaxWraithRenderState> {
    public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(
            Identifier.fromNamespaceAndPath(Yesterglass.MOD_ID, "parallax_wraith"),
            "main");
    ...
    @Override
    public void setupAnim(ParallaxWraithRenderState state) {
