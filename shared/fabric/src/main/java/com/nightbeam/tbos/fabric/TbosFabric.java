...
public final class TbosFabric implements ModInitializer {
    ...
    private void registerPayloads() {
        PayloadTypeRegistry.serverboundPlay().register(MemoryActionRequest.TYPE,MemoryActionRequest.STREAM_CODEC);
        PayloadTypeRegistry.clientboundPlay().register(MemorySnapshotPayload.TYPE,MemorySnapshotPayload.STREAM_CODEC);
