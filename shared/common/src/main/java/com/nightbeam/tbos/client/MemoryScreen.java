...
public final class MemoryScreen extends Screen {
    ...
    private void line(GuiGraphicsExtractor g,Component value,int x,int y,int w,int color) { MemoryUi.text(g,value,x,y,w,color); }
    ...
    private void drawStats(GuiGraphicsExtractor g,int x,int y,int w,MemoryBuild b) {
