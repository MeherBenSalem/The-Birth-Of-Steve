 ...
 *
 * <p>Each body is registered as a {@code tbos:<name>} test function here and
 * paired with a {@code data/tbos/test_instance/<name>.json} that supplies the
 * environment, structure and tick budget.
 *
 * <p>Every instance sets {@code "padding": 48}. Several integration fixtures
 * place authored sites up to 32 blocks wide outside Minecraft's one-block
 * {@code empty} test structure, and the padding is what keeps their worlds
 * disjoint so players and entities from parallel tests cannot trip another
 * fixture's collision-safety checks. Shrink it and fixtures collide.
 */
public final class ModGameTests {
    private static final RegistryEntry<Consumer<GameTestHelper>> REGISTRATION_IDEMPOTENT =
            ModRegistries.TEST_FUNCTIONS.register("registration_idempotent", () -> ModGameTests::registrationIsIdempotent);
    private static final RegistryEntry<Consumer<GameTestHelper>> TRANSITION_COMPLETES =
            ModRegistries.TEST_FUNCTIONS.register("transition_completes", () -> ModGameTests::transitionCompletes);
    private static final RegistryEntry<Consumer<GameTestHelper>> INTERRUPTED_TRANSITION =
            ModRegistries.TEST_FUNCTIONS.register("interrupted_transition", () -> ModGameTests::interruptedTransitionReconciles);
    private static final RegistryEntry<Consumer<GameTestHelper>> REVERSE_TRANSITION =
            ModRegistries.TEST_FUNCTIONS.register("reverse_transition", () -> ModGameTests::reverseTransitionCompletes);
    private static final RegistryEntry<Consumer<GameTestHelper>> INVALID_STATE_ID =
            ModRegistries.TEST_FUNCTIONS.register("invalid_state_id", () -> ModGameTests::invalidStateIdFailsSafely);
    private static final RegistryEntry<Consumer<GameTestHelper>> PHASE_GEOMETRY_ROUND_TRIP =
            ModRegistries.TEST_FUNCTIONS.register("phase_geometry_round_trip", () -> ModGameTests::phaseGeometryRoundTrip);
    private static final RegistryEntry<Consumer<GameTestHelper>> DEFINITION_ROTATION =
            ModRegistries.TEST_FUNCTIONS.register("definition_rotation", () -> ModGameTests::definitionRotationResolvesMarkers);
    private static final RegistryEntry<Consumer<GameTestHelper>> SITE_CODEC_ROUND_TRIP =
            ModRegistries.TEST_FUNCTIONS.register("site_codec_round_trip", () -> ModGameTests::siteCodecPreservesAuthoredState);
    private static final RegistryEntry<Consumer<GameTestHelper>> INVALID_DEFINITION_MARKER =
            ModRegistries.TEST_FUNCTIONS.register("invalid_definition_marker", () -> ModGameTests::invalidDefinitionMarkerIsRejected);
    private static final RegistryEntry<Consumer<GameTestHelper>> ALIGNMENT_LOGIC =
            ModRegistries.TEST_FUNCTIONS.register("alignment_logic", () -> ModGameTests::alignmentLogicIsDiscreteAndResettable);
    private static final RegistryEntry<Consumer<GameTestHelper>> HALL_GEOMETRY =
            ModRegistries.TEST_FUNCTIONS.register("hall_geometry", () -> ModGameTests::hallGeometryFollowsPersistentCompletion);
    private static final RegistryEntry<Consumer<GameTestHelper>> HALL_ROTATION =
            ModRegistries.TEST_FUNCTIONS.register("hall_rotation", () -> ModGameTests::hallMarkersRotateTogether);
    private static final RegistryEntry<Consumer<GameTestHelper>> SNAPSHOT_METADATA =
            ModRegistries.TEST_FUNCTIONS.register("snapshot_metadata", () -> ModGameTests::snapshotCarriesAuthoredPuzzleState);
    private static final RegistryEntry<Consumer<GameTestHelper>> CHOIR_LOGIC =
            ModRegistries.TEST_FUNCTIONS.register("choir_logic", () -> ModGameTests::choirHintEscalatesWithoutPunishment);
    private static final RegistryEntry<Consumer<GameTestHelper>> CHOIR_WORLD_COMPLETION =
            ModRegistries.TEST_FUNCTIONS.register("choir_world_completion", () -> ModGameTests::choirCompletionPersistsAndOpensRoute);
    private static final RegistryEntry<Consumer<GameTestHelper>> CHOIR_PLAYBACK =
            ModRegistries.TEST_FUNCTIONS.register("choir_playback", () -> ModGameTests::choirPlaybackUsesVisualAndSymbolState);
    private static final RegistryEntry<Consumer<GameTestHelper>> CHOIR_ROTATION =
            ModRegistries.TEST_FUNCTIONS.register("choir_rotation", () -> ModGameTests::choirMarkersRotateTogether);
    private static final RegistryEntry<Consumer<GameTestHelper>> MERIDIAN_LOGIC =
            ModRegistries.TEST_FUNCTIONS.register("meridian_logic", () -> ModGameTests::meridianRelayUsesAuthoredPositions);
    private static final RegistryEntry<Consumer<GameTestHelper>> MERIDIAN_WORLD_COMPLETION =
            ModRegistries.TEST_FUNCTIONS.register("meridian_world_completion", () -> ModGameTests::meridianCompletionBuildsDecayedRoute);
    private static final RegistryEntry<Consumer<GameTestHelper>> MERIDIAN_RESET_SAFETY =
            ModRegistries.TEST_FUNCTIONS.register("meridian_reset_safety", () -> ModGameTests::meridianResetAndDestinationSafety);
    private static final RegistryEntry<Consumer<GameTestHelper>> MERIDIAN_ROTATION =
            ModRegistries.TEST_FUNCTIONS.register("meridian_rotation", () -> ModGameTests::meridianMarkersRotateTogether);
    private static final RegistryEntry<Consumer<GameTestHelper>> CURATOR_PROGRESS =
            ModRegistries.TEST_FUNCTIONS.register("curator_progress", () -> ModGameTests::curatorProgressIsStateDriven);
    private static final RegistryEntry<Consumer<GameTestHelper>> ORRERY_GEOMETRY =
            ModRegistries.TEST_FUNCTIONS.register("orrery_geometry", () -> ModGameTests::orreryGeometryFollowsTemporalState);
    private static final RegistryEntry<Consumer<GameTestHelper>> ORRERY_INTERACTION =
            ModRegistries.TEST_FUNCTIONS.register("orrery_interaction", () -> ModGameTests::orreryCoreAndAnchorsControlEncounter);
    private static final RegistryEntry<Consumer<GameTestHelper>> PHOENIX_GUARDIAN_REBIRTH =
            ModRegistries.TEST_FUNCTIONS.register("phoenix_guardian_rebirth", () -> ModGameTests::phoenixGuardianRisesExactlyOnce);
    private static final RegistryEntry<Consumer<GameTestHelper>> SITE_MANAGED_CURATOR =
            ModRegistries.TEST_FUNCTIONS.register("site_managed_curator", () -> ModGameTests::siteManagedCuratorDoesNotRise);
    private static final RegistryEntry<Consumer<GameTestHelper>> CHAMBER_MINOTAUR =
            ModRegistries.TEST_FUNCTIONS.register("chamber_minotaur", () -> ModGameTests::chamberMinotaurResolvesFromPool);
    private static final RegistryEntry<Consumer<GameTestHelper>> CURATOR_RUNTIME =
            ModRegistries.TEST_FUNCTIONS.register("curator_runtime", () -> ModGameTests::curatorRuntimePersistsHealthAndReward);
    private static final RegistryEntry<Consumer<GameTestHelper>> MEMORY_PLATE_VARIANTS =
            ModRegistries.TEST_FUNCTIONS.register("memory_plate_variants", () -> ModGameTests::memoryPlateVariantsRemainDistinct);
    private static final RegistryEntry<Consumer<GameTestHelper>> MEMORY_LANTERN_PERSISTENCE =
            ModRegistries.TEST_FUNCTIONS.register("memory_lantern_persistence", () -> ModGameTests::memoryLanternPersistsPlaybackState);
    private static final RegistryEntry<Consumer<GameTestHelper>> FRACTURE_SHRINE_VARIANTS =
            ModRegistries.TEST_FUNCTIONS.register("fracture_shrine_variants", () -> ModGameTests::fractureShrinesDistributeAdventureItems);
    private static final RegistryEntry<Consumer<GameTestHelper>> FRACTURE_SHRINE_PLACEMENT =
            ModRegistries.TEST_FUNCTIONS.register("fracture_shrine_placement", () -> ModGameTests::fractureShrinesUseWorldSeededLocations);
    private static final RegistryEntry<Consumer<GameTestHelper>> FRACTURE_SHRINE_PLAN =
            ModRegistries.TEST_FUNCTIONS.register("fracture_shrine_plan", () -> ModGameTests::fractureShrinePlanIsStableAndBuildsOnce);
    private static final RegistryEntry<Consumer<GameTestHelper>> FRACTURE_SHRINE_EXISTING_WORLD =
            ModRegistries.TEST_FUNCTIONS.register(
                    "fracture_shrine_existing_world", () -> ModGameTests::existingWorldBuildsShrineInResidentChunk);
    private static final RegistryEntry<Consumer<GameTestHelper>> FRACTURE_SHRINE_FORCED =
            ModRegistries.TEST_FUNCTIONS.register("fracture_shrine_forced", () -> ModGameTests::forcedShrineRegistersForDiscovery);
    private static final RegistryEntry<Consumer<GameTestHelper>> ONBOARDING_GRANT =
            ModRegistries.TEST_FUNCTIONS.register("onboarding_grant", () -> ModGameTests::onboardingGreetsEachPlayerOnce);
    private static final RegistryEntry<Consumer<GameTestHelper>> UTILITY_BLOCK_ENTITIES =
            ModRegistries.TEST_FUNCTIONS.register("utility_block_entities", () -> ModGameTests::utilityBlocksCarryTheirRenderAnchors);
    private static final RegistryEntry<Consumer<GameTestHelper>> ADVENTURE_WORLD_METADATA =
            ModRegistries.TEST_FUNCTIONS.register("adventure_world_metadata", () -> ModGameTests::adventureWorldMetadataPersistsCoordinates);
    private static final RegistryEntry<Consumer<GameTestHelper>> FRACTURED_ARCHIVE_DIMENSION =
            ModRegistries.TEST_FUNCTIONS.register("fractured_archive_dimension", () -> ModGameTests::fracturedArchiveDimensionLoads);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_RUN_CODEC =
            ModRegistries.TEST_FUNCTIONS.register("archive_run_codec", () -> ModGameTests::archiveRunCodecRoundTrip);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_RUN_STORAGE =
            ModRegistries.TEST_FUNCTIONS.register("archive_run_storage", () -> ModGameTests::archiveRunStorageIndexesActiveRuns);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_RUN_GENERATOR =
            ModRegistries.TEST_FUNCTIONS.register("archive_run_generator", () -> ModGameTests::archiveRunGeneratorIsDeterministicAndVaried);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_ROOM_BLUEPRINT =
            ModRegistries.TEST_FUNCTIONS.register("archive_room_blueprint", () -> ModGameTests::archiveRoomBlueprintIsBoundedAndWalkable);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_BLUEPRINT_SWEEP =
            ModRegistries.TEST_FUNCTIONS.register("archive_blueprint_sweep", () -> ModGameTests::archiveBlueprintHoldsAcrossSeeds);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_RUN_ENTRY =
            ModRegistries.TEST_FUNCTIONS.register("archive_run_entry", () -> ModGameTests::archiveRunEntryValidatesBeforeMutation);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_SHARED_REVIVES =
            ModRegistries.TEST_FUNCTIONS.register("archive_shared_revives", () -> ModGameTests::archiveSharedRevivesFailOnFourthDeath);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_FLOOR_PROGRESSION =
            ModRegistries.TEST_FUNCTIONS.register("archive_floor_progression", () -> ModGameTests::archiveFloorProgressionIsEndless);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_CHOIR_PATTERNS =
            ModRegistries.TEST_FUNCTIONS.register("archive_choir_patterns", () -> ModGameTests::archiveChoirPatternsAreDeterministic);
    private static final RegistryEntry<Consumer<GameTestHelper>> ARCHIVE_ENCOUNTER_STATE =
    ...
    private static final RegistryEntry<Consumer<GameTestHelper>> FRACTURE_SHRINE_MIN_HEIGHT =
            ModRegistries.TEST_FUNCTIONS.register("fracture_shrine_min_height", () -> ModGameTests::fractureShrineClampsToMinHeight);
    private static final RegistryEntry<Consumer<GameTestHelper>> LENSWARD_CONTRACT =
            ModRegistries.TEST_FUNCTIONS.register("lensward_contract", () -> ModGameTests::lenswardContractIsComplete);
    private static final RegistryEntry<Consumer<GameTestHelper>> LENSWARD_BEAM =
            ModRegistries.TEST_FUNCTIONS.register("lensward_beam", () -> ModGameTests::lenswardBeamStrikesOnce);
    private static final RegistryEntry<Consumer<GameTestHelper>> LENSWARD_LINE_OF_SIGHT =
            ModRegistries.TEST_FUNCTIONS.register("lensward_line_of_sight", () -> ModGameTests::lenswardBeamAbortsWithoutLineOfSight);
    private static final RegistryEntry<Consumer<GameTestHelper>> LENSWARD_TETHER =
            ModRegistries.TEST_FUNCTIONS.register("lensward_tether", () -> ModGameTests::lenswardHoldsItsWard);
    private static final RegistryEntry<Consumer<GameTestHelper>> PARALLAX_WRAITH_DISPLACEMENT =
            ModRegistries.TEST_FUNCTIONS.register(
                    "parallax_wraith_displacement", () -> ModGameTests::parallaxWraithDisplacesBehindTarget);
    private static final RegistryEntry<Consumer<GameTestHelper>> MERIDIAN_SENTINEL_SLAM =
            ModRegistries.TEST_FUNCTIONS.register("meridian_sentinel_slam", () -> ModGameTests::meridianSentinelSlamStrikesInRadius);
    private static final RegistryEntry<Consumer<GameTestHelper>> HOUR_CANTOR_REFRAIN =
            ModRegistries.TEST_FUNCTIONS.register("hour_cantor_refrain", () -> ModGameTests::hourCantorRefrainSlowsAudience);
    private static final RegistryEntry<Consumer<GameTestHelper>> THEME_EXCLUSIVE_ABILITY =
            ModRegistries.TEST_FUNCTIONS.register("theme_exclusive_ability", () -> ModGameTests::themeExclusiveAbilityTelegraphs);

    private ModGameTests() {
    }

    /**
     * Touching this class is what queues every test function; the loader flushes
     * later.
     *
     * <p>The matching {@code GameTestInstance}s are datapack JSON under
     * {@code data/tbos/test_instance/}, not code: {@code TestData} and
     * {@code FunctionGameTestInstance} are vanilla and fully codec-serializable
     * (padding included), so the same files drive both loaders.
     */
    ...
    private static void lenswardBeamStrikesOnce(GameTestHelper helper) {
        ...
        var victim = helper.spawn(
                VanillaCompat.SHEEP, new Vec3(9.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        victim.setNoAi(true);
    ...
    private static void lenswardHoldsItsWard(GameTestHelper helper) {
        ...
        var near = helper.spawn(VanillaCompat.SHEEP, new Vec3(8.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        near.setNoAi(true);
        var far = helper.spawn(VanillaCompat.SHEEP, new Vec3(19.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        far.setNoAi(true);
    ...
    private static void parallaxWraithDisplacesBehindTarget(GameTestHelper helper) {
        ...
        var victim = helper.spawn(VanillaCompat.SHEEP, new Vec3(10.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        victim.setNoAi(true);
    ...
    private static void meridianSentinelSlamStrikesInRadius(GameTestHelper helper) {
        ...
        var near = helper.spawn(VanillaCompat.SHEEP, new Vec3(5.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        near.setNoAi(true);
        var far = helper.spawn(VanillaCompat.SHEEP, new Vec3(14.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        far.setNoAi(true);
    ...
    private static void hourCantorRefrainSlowsAudience(GameTestHelper helper) {
        ...
        var victim = helper.spawn(VanillaCompat.SHEEP, new Vec3(7.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        victim.setNoAi(true);
        float startHealth = victim.getHealth();
    ...
    private static void themeExclusiveAbilityTelegraphs(GameTestHelper helper) {
        ...
        var victim = helper.spawn(VanillaCompat.SHEEP, new Vec3(8.5D, 1.0D, 4.5D), EntitySpawnReason.EVENT);
        victim.setNoAi(true);
     ...
     * is the seam the mechanic actually hangs on: if the override ever stops
     * intercepting, the first blow kills and this fails immediately.
     */
    private static void phoenixGuardianRisesExactlyOnce(GameTestHelper helper) {
        combatFloor(helper, 9);
        PhoenixGuardianEntity curator = helper.spawn(
        ...
        float half = curator.getMaxHealth() * PhoenixGuardianEntity.REBIRTH_HEALTH_FRACTION;
     ...
     */
    private static void siteManagedCuratorDoesNotRise(GameTestHelper helper) {
        combatFloor(helper, 9);
        PhoenixGuardianEntity curator = helper.spawn(
                ModEntities.PHOENIX_GUARDIAN.get(),
                new Vec3(4.5D, 1.0D, 4.5D),
    ...
    private static void chamberMinotaurResolvesFromPool(GameTestHelper helper) {
        helper.assertTrue(
                ArchiveEnemyKind.parse("tbos:minotaur").isPresent(),
                "Minotaur is not addressable from encounter-pool config");
        combatFloor(helper, 9);
        MinotaurEntity minotaur = helper.spawn(
        ...
        helper.assertTrue(
                minotaur.getPhase() == MinotaurEntity.Phase.IDLE,
    ...
    private static void existingWorldBuildsShrineInResidentChunk(GameTestHelper helper) {
        net.minecraft.server.level.ServerLevel level = helper.getLevel();
        TemporalSiteSavedData data = TemporalSiteManager.data(level);
