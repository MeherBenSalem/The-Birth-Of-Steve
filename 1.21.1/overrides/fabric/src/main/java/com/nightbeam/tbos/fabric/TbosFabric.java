...
public final class TbosFabric implements ModInitializer {
    ...
    private void registerPayloads() {
        ...
        PayloadTypeRegistry.playS2C().register(SiteSnapshotPayload.TYPE, SiteSnapshotPayload.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(ArchiveQuestPayload.TYPE, ArchiveQuestPayload.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(ArchivePuzzlePayload.TYPE, ArchivePuzzlePayload.STREAM_CODEC);
        PayloadTypeRegistry.playS2C().register(ArchiveFloorIntroPayload.TYPE, ArchiveFloorIntroPayload.STREAM_CODEC);
