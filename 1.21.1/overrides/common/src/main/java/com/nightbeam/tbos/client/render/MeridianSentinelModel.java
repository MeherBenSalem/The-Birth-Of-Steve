 ...
 */
public final class MeridianSentinelModel extends EntityModel<MeridianSentinelEntity> {
    public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(Yesterglass.MOD_ID, "meridian_sentinel"),
            "main");
    ...
    public void setupAnim(
        ...
        MeridianSentinelRenderState state = new MeridianSentinelRenderState();
        ...
        state.slamProgress = entity.getSlamProgress(ageInTicks - entity.tickCount);
