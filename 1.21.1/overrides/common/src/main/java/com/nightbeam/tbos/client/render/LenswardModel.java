...
public final class LenswardModel extends EntityModel<LenswardEntity> {
    public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(Yesterglass.MOD_ID, "lensward"),
            "main");
    ...
    public void setupAnim(
        ...
        LenswardRenderState state = new LenswardRenderState();
        ...
        state.beamProgress = entity.getBeamProgress(ageInTicks - entity.tickCount);
