...
public record ArchiveRoomNode(
        ...
        int graphDepth,
        int difficulty,
        List<ResourceLocation> allowedLootTables,
        List<ResourceLocation> allowedMonsterGroups,
    ...
    public static final Codec<ArchiveRoomNode> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ResourceLocation.CODEC.fieldOf("template_id").forGetter(ArchiveRoomNode::templateId),
            ...
            ResourceLocation.CODEC.listOf().optionalFieldOf("allowed_loot_tables", List.of())
                    .forGetter(ArchiveRoomNode::allowedLootTables),
            ResourceLocation.CODEC.listOf().optionalFieldOf("allowed_monster_groups", List.of())
