...
public final class MemoryIcons {
    private static final ResourceLocation ATLAS = ResourceLocation.fromNamespaceAndPath("tbos", "textures/gui/greek/icons.png");
    ...
    public static void draw(GuiGraphics graphics, int id, int x, int y, int size) {
        ...
        graphics.blit(ATLAS, x, y, size, size, (float)u, (float)v, sw, sh, ATLAS_WIDTH, ATLAS_HEIGHT);
    }
}
