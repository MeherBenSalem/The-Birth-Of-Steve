...
public final class LenswardRenderer extends MobRenderer<LenswardEntity, LenswardModel> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Yesterglass.MOD_ID, "textures/entity/lensward.png");
    private static final ResourceLocation CORE =
            ResourceLocation.fromNamespaceAndPath(Yesterglass.MOD_ID, "textures/entity/lensward_core.png");
