...
public final class HourCantorRenderer extends MobRenderer<HourCantorEntity, HourCantorModel> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Yesterglass.MOD_ID, "textures/entity/hour_cantor.png");
    private static final ResourceLocation CORE =
            ResourceLocation.fromNamespaceAndPath(Yesterglass.MOD_ID, "textures/entity/hour_cantor_core.png");
