 ...
 */
public final class MemoryLeechModel extends EntityModel<MemoryLeechEntity> {
    public static final ModelLayerLocation MODEL_LAYER = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(Yesterglass.MOD_ID, "memory_leech"),
            "main");
    ...
    public void setupAnim(
        ...
        MemoryLeechRenderState state = new MemoryLeechRenderState();
        ...
        state.pounceProgress = entity.getPounceProgress(ageInTicks - entity.tickCount);
