...
public final class ArchiveRoomTemplates {
    ...
    private static final Map<ResourceLocation, ArchiveRoomTemplate> BY_ID = TEMPLATES.stream()
    ...
    public static Optional<ArchiveRoomTemplate> find(ResourceLocation id) {
        return Optional.ofNullable(BY_ID.get(id));
    }

    public static ArchiveRoomTemplate require(ResourceLocation id) {
    ...
    private static ArchiveRoomTemplate template(
        ...
        List<BlockPos> bossMarkers = category == ArchiveRoomCategory.FINAL_BOSS
                ...
                : List.of();
        ResourceLocation commonLoot = id(category == ArchiveRoomCategory.EXIT_REWARD
                ? "loot/boss_reward"
                : category == ArchiveRoomCategory.SECRET
                        ? "loot/secret"
                        : category == ArchiveRoomCategory.MINI_BOSS ? "loot/lesser_boss" : "loot/common");
        ResourceLocation monsterGroup = id(switch (category) {
