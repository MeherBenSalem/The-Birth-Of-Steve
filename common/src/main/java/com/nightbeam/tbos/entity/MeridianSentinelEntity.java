...
public final class MeridianSentinelEntity extends Monster {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder entityData) {
        ...
        entityData.define(SLAM_PHASE, (byte) SlamPhase.IDLE.ordinal());
        entityData.define(SLAM_PHASE_TICKS, 0);
    }
    ...
    private static final class MeridianSlamGoal extends Goal {
        ...
        @Override
        public void tick() {
            ServerLevel level = getServerLevel(sentinel);
        ...
        private void release(ServerLevel level) {
            ...
            for (LivingEntity victim : caught) {
                ...
                victim.hurtServer(
                        level,
                        sentinel.damageSources().indirectMagic(sentinel, sentinel),
                        SLAM_DAMAGE);
            }
        }
